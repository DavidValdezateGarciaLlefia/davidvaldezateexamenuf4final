    ...
    return (
        <div className="pt-5">
            ...
            <form action="" className="form p-4 border shadow bordered mt-5 mx-auto" style={{ width: '400px' }}>
                ...
                <input type="text" className="form-control" id="email" placeholder="usuario@mail.com" />
                <label htmlFor="pass" className="mt-2 form-label">Contraseña:</label>
                <input type="password" className="form-control" id="pass" />
                <input type="button" className="mt-4 w-100 btn btn-primary" value="Entrar" id="enviar" />
            </form>
        </div>
    );
}